...
/** @author incubatio 
  ...
  *
  */
class Incube_View_Helper_HTML extends Incube_View_Helper_Router {
	...
	public function link($label, $params) {
		...
		return Incube_HTML::createTag("a", $paramsUrl, $label);
	}  
	...
	public function img(array $params) {
		return Incube_HTML::createTag("img", $params);
	}
	...
	public function script(array $params, $jsCode = "") {
		return Incube_HTML::createTag("script", $params, $jsCode);
	}
